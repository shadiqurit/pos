	...
	<table width="95%" align="center">
		...
		<tr>
			<td align="center">
				<span>													 
                <br>
Address: <?php echo (!empty(trim($company_address))) ? $this->lang->line('company_address')."".$company_address."<br>" : '';?>
		            <?= $company_city; ?>
  ...
  <tr><td align="center"><strong>-----------------INVOICE-----------------</strong></td></tr>
		<tr>
			<td>
				<table width="100%">
					<tr>
        ...
        <th style="font-size: 11px; text-align: left;padding-left: 2px; padding-right: 2px;">Details</th>
				
        <th style="font-size: 11px; text-align: left;padding-left: 2px; padding-right: 2px;">Warranty &amp; Other Information</th>
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              foreach ($q2->result() as $res2) {
			                  ...
			                  echo "<td style='padding-left: 2px; padding-right: 2px;'>".$res2->description."</td>";
                ...
                <b><u>Note:</u></b> <i><?=$sales_note;?></i>
					...
					<tr>
						<td colspan="<?=$mrp_column+5?>" align="left">
                          ...
                          <th style="border:1px solid;text-align:center;">Payment Method</th>
					...
					<?php
					 ...
					 ?>
					<tr>
              <td colspan="<?=$mrp_column+5?>" align="center">----------Thank you. Please visit again.----------</td>
					</tr>
