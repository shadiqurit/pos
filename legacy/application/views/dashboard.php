...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content dashboard-modern">
      ...
      <?php if(!is_user() && $CI->permissions('dashboard_info_box_1')){ ?> 
        <div class="row">
          ...
          <div class="small-box bg-dream-pink">
            <div class="inner text-uppercase">
              <h3 class="purchase_due"><?= $CI->currency(0); ?></h3><p><?= $this->lang->line('purchase_due'); ?></p>
            </div>
            <div class="icon">
              <i class="fa fa-money "></i>
            </div>
             
            <a href="<?php echo $base_url; ?>suppliers" class="small-box-footer text-uppercase">View Details <i class="fa fa-arrow-circle-right"></i>
          </a>
                    </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          <div class="small-box bg-dream-purple">
            <div class="inner text-uppercase">
              <h3 class="sales_due"><?= $CI->currency(0); ?></h3><p><?= $this->lang->line('sales_due'); ?></p>
            </div>
            <div class="icon">
              <i class="fa fa-group "></i>
            </div>
             
            <a href="<?php echo $base_url; ?>customers" class="small-box-footer text-uppercase">View Details <i class="fa fa-arrow-circle-right"></i>
          </a>
                    </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          <div class="small-box bg-dream-maroon">
            <div class="inner text-uppercase">
              <h3 class="tot_sal_grand_total"><?= $CI->currency(0); ?></h3><p><?= $this->lang->line('sales'); ?></p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-paper-outline"></i>
            </div>
             
            <a href="<?php echo $base_url; ?>sales" class="small-box-footer text-uppercase">View Details <i class="fa fa-arrow-circle-right"></i>
          </a>
                    </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          <div class="small-box bg-dream-green">
            <div class="inner text-uppercase">
              <h3 class="tot_exp"><?= $CI->currency(0); ?></h3><p><?= $this->lang->line('expense'); ?></p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-paper-outline"></i>
            </div>
             
            <a href="<?php echo $base_url; ?>expense" class="small-box-footer text-uppercase">View Details <i class="fa fa-arrow-circle-right"></i>
          </a>
                    </div>
        </div>
      ...
      <?php if(!is_user() && $CI->permissions('dashboard_info_box_2')){ ?> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box dashboard-info-card card-customers">
        ...
        <!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box dashboard-info-card card-suppliers">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box dashboard-info-card card-purchases">
        ...
        <!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box dashboard-info-card card-invoices">
