        ...
        <div class="row login-box">
            <div class="col-lg-6 form-section">
                <div class="form-inner">
                    ...
                    <span class="auth-kicker">Secure verification</span>
                    <h3>Enter the OTP sent to your email</h3>
                    <p class="auth-subtitle">Use the verification code from your inbox to continue.</p>
     ...
     <div class="text-success tex-center"><?php echo $this->session->flashdata('success'); ?></div>
      ...
      <input type="hidden" name="email" id="email" value="<?= $this->session->userdata('email')?>">
                        ...
                        <div class="form-group position-relative clearfix">
                            <input name="otp" type="password" class="form-control" placeholder="Enter OTP" id="otp">
                        </div>
                        <div class="form-group mb-0 clearfix">
                            <button type="submit" class="btn btn-lg btn-primary btn-theme">Submit</button>
                        </div>
