                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-2" style="padding-right:0;">
                                    <input type="text" value="<?= $init_code; ?>" class="form-control no-padding" style='font-size:20px;' id="init_code" name="init_code" placeholder="" readonly>
                                       <span id="init_code_msg" style="display:none" class="text-danger"></span>
                                 </div>
                                 <div class="col-sm-1" style="padding-left:1;">
                                    <input type="text" style='font-size:20px;' value="<?php echo  $count_id; ?>" class="form-control no_special_char" id="count_id" name="count_id" placeholder="" readonly>
