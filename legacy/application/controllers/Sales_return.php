...
class Sales_return extends MY_Controller {
  ...
  public function add($id){
		...
		if($q1->num_rows()>0){
			...
			legacy_redirect(base_url('sales_return/edit/'.$q1->row()->id),'refresh');exit();
		}
			...
			$row[] = ($sales->created_by);
					...
					$str2 = '<div class="btn-group" title="View Account">
										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											$str2.='<li>
												<a title="Take Print" target="_blank" href="sales_return/print_invoice/'.$sales->id.'">
													<i class="fa fa-fw fa-print text-blue"></i>Print
												</a>
											</li>

											<li>
												<a title="Download PDF" target="_blank" href="'.base_url().'sales_return/pdf/'.$sales->id.'">
