...

{
    ...
    function index(){
        legacy_redirect(base_url('subscription'),'refresh');

    }

    public function free_package($pid=''){

        legacy_redirect(base_url('online_payments/paymentSuccess/Free/'.$pid),'refresh');
    }
    ...
    function buy_package($gateway='paypal',$pid){
        ...
        if($gateway=='paypal'){
            ...
            legacy_redirect($pay['longurl'], 'refresh');
        }
    }
