...
class MY_Controller extends CI_Controller{
      ...
      public function load_global($validate_subs='VALIDATE'){
            ...
            if($this->session->userdata('logged_in')!=1){ legacy_redirect(base_url().'logout','refresh');    }
      ...
      public function permissions($permissions=''){
        ...
        public function permission_check($value=''){
          if(!$this->permissions($value)){
             legacy_show_error("Access Denied", 403, $heading = "You Don't Have Enough Permission!!");
          }
          return true;
        }
        ...
        public function belong_to($table,$rec_id){
          if(!is_it_belong_to_store($table,$rec_id)){
            legacy_show_error("Data may not avaialable!!", 403, $heading = "Something Went Wrong!!");
          }
        }
